...
<p align="center">
  <img src="docs/images/icon.png" width="128" alt="PureDoc 图标">
  <br>
...
2. **Install to Applications**
   ...
   **Method C: First Launch Allow**
   5. Right-click on PureDoc.app and select "Open"
   6. Click "Open" in the pop-up dialog
   7. After the first successful launch, you can double-click to open it directly
...
> Since `v0.2.0`, PureDoc no longer depends on `pandoc`.

Just install necessary python packages.
...
| **python-docx** | 1.2.0+ | Python library for creating and manipulating Word (.docx) documents |
| **markdown-it-py** | 4.0.0+ | Markdown parser, supports CommonMark standard |
